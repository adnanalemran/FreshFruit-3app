...
const AddItems = () => {
    ...
    const { mutate, status } = useMutation({
        mutationFn: async (newItem: FormData) => {
            return http.post('/portfolio/slider', newItem, {
                headers: {
        ...
        onError: (e: AxiosError) => { // Explicitly type 'e' as AxiosError
            const errorMessage = (e.response?.data as { error?: string })?.error || 'Something went wrong';
                            ...
                            <DrawerDescription>
                                <div className='grid lg:grid-cols-2 grid-rows-c gap-4'>
                                    ...
                                    <div className="grid w-full items-center gap-1.5">
                                        ...
                                        '> (Image Size Max 10MB , best image size 1585 x 998 )</span></Label>
                                        <Input
                                            id="image"
                                            type="file"
                                            onChange={handleInputChange}
