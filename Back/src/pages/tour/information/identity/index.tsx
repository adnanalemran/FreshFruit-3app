        ...
        <Layout>
            ...
            <Layout.Body className="container mx-auto py-6 px-4">
                <div className='mb-6 flex items-center justify-between'>
                    <div>
                        <h2 className='text-2xl font-bold tracking-tight '> Identity Information  Tour Site 
                        </h2>
                        <p className='text-muted-foreground'>
                            Here&apos;s   information about your Tour Site !
                        </p>
                    </div>
                </div>
                <div className="flex gap-2 flex-col lg:flex-row ">
                    <Card className="lg:w-1/2 w-full mx-auto">
                        <CardHeader>
                            <CardTitle className='flex justify-between'><p className='text-2xl'>Header -tour <h2 className='text-base   text-muted-foreground' > Portfolio site Header section content  </h2>     </p>
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
