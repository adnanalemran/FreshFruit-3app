...
const ImageHandel = ({ destination_id }: ImageHandelProps) => {
    ...
    const { data: LoadData, isLoading, isError } = useQuery({
        queryKey: ["packageImageItem", destination_id],
        queryFn: async () => {
            const res = await http.get(`/tour/package-images/${destination_id}`);
    ...
    const deleteMutation = useMutation({
        mutationFn: async (id: string) => {
            await http.delete(`/tour/package-images/${id}`);
        },
        onSuccess: () => {
            toast({
                title: 'Success',
            ...
            queryClient.invalidateQueries({ queryKey: ['packageImageItem', destination_id] });
    ...
    const uploadMutation = useMutation({
        mutationFn: async (file: File) => {
            ...
            formData.append('package_id', destination_id); // Append destination ID
            formData.append('file_name', file); // Append selected image
            await http.post('/tour/package-images', formData, {
