          ...
          <div className='   '>
            <div>
              <h3 className="text-sm font-medium ">
                Name of client : {itemDetails?.name ? itemDetails?.name : "No Title"}</h3>
            </div>
            <div>
              <h3 className="text-sm font-medium ">

                Ratings : {itemDetails?.ratings ? itemDetails?.ratings : "No  Data"}</h3>
            </div>
            <div>
              <h3 className="text-sm font-medium ">

                review : {itemDetails?.review ? itemDetails?.review : "No  Data"}</h3>
            </div>
            <div>
              <h3 className="text-sm font-medium ">

                platform : {itemDetails?.platform ? itemDetails?.platform : "No  Data"}</h3>
            </div>
